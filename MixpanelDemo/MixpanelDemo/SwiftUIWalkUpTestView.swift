  ...
  var body: some View {
    ScrollView {
      VStack(alignment: .leading, spacing: 10) {
        ...
        Text("Tap \"Delete\". Walk-up stops at inner button (\"delete_item\"), not outer card (\"product_card\").")
          .font(.caption)
          .foregroundColor(.gray)
        ...
        Text("Tap the text. Even though it has its own accessibilityLabel (\"inner_label\"), walk-up still activates and takes the clickable parent's identity. $el_id = \"outer_button\".")
          .font(.caption)
          .foregroundColor(.gray)
